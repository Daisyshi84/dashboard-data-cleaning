...
openxlsx::write.xlsx(dataset_names, file = '\\\\cdc.gov\\locker\\CPR_RMOI\\Response Activities\\2019 nCoV\\Evaluation Team\\Dashboard\\OverTheTimeVariables\\OverTheTimeVariables_Today.xlsx') 
